package gt.edu.umg.ingenieria.programmer.calculator.service;
...
public class ProgramService {
    public boolean isbinary(PrograModel model){
    ...
    public int binaryToDecimal(PrograModel model){
    ...
    public String binaryToOctal(PrograModel model){
        PrograModel mod = new PrograModel();
        mod.setB(binaryToDecimal(model));
        String octal = decimalToOct(mod);
        return octal;
    }

    public String binaryToHex(PrograModel model){
        PrograModel mod = new PrograModel();
        mod.setB(binaryToDecimal(model));
    ...
    public String decimalToBin(PrograModel model){
    ...
    public String decimalToOct(PrograModel model){
        int decimal = model.getB();
        int residuo;
        String octal = "";
    ...
    public String decimalToHex(PrograModel model){
        int decimal = model.getB();
        int residuo;
        String hexadecimal = "";
    ...
    public int octalToDecimal(PrograModel model){
    ...
    public String octalToBinary(PrograModel model){
        PrograModel mod = new PrograModel();
    ...
    public String octalToHex(PrograModel model){
        PrograModel mod = new PrograModel();
        mod.setB(octalToDecimal(model));
    ...
    public String hexToBinary(PrograModel model){
        PrograModel mod = new PrograModel();
    ...
    public String hexToOctal(PrograModel model){
        PrograModel mod = new PrograModel();
        mod.setB(hexToDecimal(model));
    ...
    public int hexToDecimal(PrograModel model){
